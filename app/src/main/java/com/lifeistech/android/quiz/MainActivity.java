...
public class MainActivity extends ActionBarActivity {
    ...
    private void makeQuestions() {
        // TODO [03] ここから
        Question q1 = new Question(R.drawable.japan,"","","","","");
        Question q2 = new Question(R.drawable.japan,"","","","","");
    ...
    class Question {
         ...
         * 不正解の答え3
         */
        private final String wrong_3;


        public Question(int image_id, String question_text, String answer, String wrong_1, String wrong_2,String wrong_3) {
        ...
        public String[] getChoices() {
            // ボタンの位置をランダムにする
            String choices_tmp[] = {answer, wrong_1, wrong_2,wrong_3};
            // 配列からリストへ
